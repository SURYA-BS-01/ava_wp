...
class VectorStore:
    ...
    REQUITED_ENV_VARS = ["QDRANT_API_KEY", "QDRANT_URL"]
    ...
    def _validate_env_vars(self) -> None:
        ...
        missing_vars = [var for var in self.REQUITED_ENV_VARS if not os.getenv(var)]
        if missing_vars:
            raise ValueError(
    ...
    def find_similar_memory(self, text: str) -> Optional[Memory]:
        """Find a similar memory based on the input text.
        Args:
