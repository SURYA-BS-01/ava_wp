...
class TextToImage:
    ...
    def __init__(self):
        """Initialize the TextToImage module and validate env variables."""
    ...
    def generate_image(self, prompt: str, output_path: str = "") -> bytes:
        ...
        try:
            ...
            raise TextToImageError (f"Error generating image: {str(e)}") from e
    ...
    async def enhance_prompt(self, prompt: str) -> str:
        """Enhance the given text prompt using a language model."""
        try:
